  ...
  _createClass(RcSelect, [{
    ...
    value: function onSelect(value) {
      ...
      if (this.props.form.schema.type === "array") {
        ...
        this.setState(function (prevState) {
          ...
          _this3.props.onChangeValidate(_this3.state.currentValue);
        });
      } else {
    ...
    value: function onDeselect(value) {
      ...
      if (this.props.form.schema.type === "array") {
        this.setState(function (prevState) {
          ...
          _this4.props.onChangeValidate(_this4.state.currentValue);
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      if (this.state.items && this.state.items.length > 0) {
        options = this.state.items.map(function (item) {
        ...
        options = this.props.form.titleMap.map(function (item) {
          return _react["default"].createElement(_rcSelect.Option, {
            key: item.value,
            value: item.value
          }, item.name);
